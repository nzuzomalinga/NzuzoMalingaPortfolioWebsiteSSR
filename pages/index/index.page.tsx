  ...
  return (
    <main>
      ...
      <div className="call-to-action">
        <a href='https://calendly.com/nzuzomalinga/interview-me'> Interview me 📋</a>
        <a href='https://calendly.com/nzuzomalinga/software-development-consultation'> Full-stack Development 🥪</a>
        <a href='https://calendly.com/nzuzomalinga/front-end-development-consulting'> Front-end Development 🖌️</a>
        <a href='https://calendly.com/nzuzomalinga/seo-consultation'> SSR and SEO 📈</a>
      </div>
